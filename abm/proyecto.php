...
if (isset($_POST['save'])) {
  ...
  if ($agregando) {
    $query = "INSERT INTO proyectos(nombre, descripcion, estado, id_jefe) 
    VALUES ('{$nombre}', '{$descripcion}', {$estado}, {$id_usuario})";
  } else {
...
<body>
  ...
  <form method="POST" class="w-[500px] mx-auto p-8 shadow-2xl rounded-xl">
    ...
    <input
      ...
      name="save"
    />
    <a href="../proyectos.php" class="block w-full py-2 bg-gray-100 text-center rounded-xl">Atrás</a>
